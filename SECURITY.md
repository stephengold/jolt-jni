# Security policies of Jolt JNI

To report a security vulnerability in the Jolt-JNI project,
...
At the present time, the Jolt JNI project does not have a bug-bounty program.

To suggest improvements to these policies,
[open an issue at GitHub](https://github.com/stephengold/jolt-jni/issues/new).
