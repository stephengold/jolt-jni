...
+ Add the `setTireMaxImpulseCallback()` method
  to the `WheeledVehicleController` class. (issue #42)
+ Added chaining to 10 public methods in `CompoundShapeSettings`
  and `ExtendedUpdateSettings`.
